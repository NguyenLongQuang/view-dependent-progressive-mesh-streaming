...
//     this->remove_property(points_);
//     this->remove_property(vertex_normals_);
//     this->remove_property(vertex_colors_);
//     this->remove_property(vertex_texcoords_);
//     this->remove_property(vertex_status_);
//     this->remove_property(halfedge_status_);
//     this->remove_property(edge_status_);
//     this->remove_property(face_normals_);
//     this->remove_property(face_colors_);
//     this->remove_property(face_status_);
//
